...
PRIMARY_API_URL = 'https://api-inference.huggingface.co/models/meta-llama/Llama-2-7b-hf'
BACKUP_API_URL = 'https://api-inference.huggingface.co/models/meta-llama/Llama-2-7b-chat-hf'
